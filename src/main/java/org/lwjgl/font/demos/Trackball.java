...
import org.lwjgl.font.demos.util.Quaternion;
import org.lwjgl.font.util.Vector3f;

/**
 * Simple trackball-like motion adapted (ripped off) from projtex.c (written by
 * David Yu and David Blythe). See the SIGGRAPH '96 Advanced OpenGL course
 * notes.
 * 
 * 
 * Usage:
 ...
 * <li>call tbAnimate(GL_FALSE) if you want the trackball to stop spinning after
...
public class Trackball extends MouseAdapter implements MouseMotionListener {
	...
	public FloatBuffer tbMatrix(FloatBuffer matrix) {
		return curquat.toColumArray(matrix);
	}
